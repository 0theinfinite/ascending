...
def scrape_reviews(url):
    ...
    # //*[@id="Reviews-react-component-75ffaad9-746c-4947-b789-273d296bf167"]/div/div/div/div/div
...
def main():
    input_csv = 'E:/_UChicago/MACS30122/final-project-ascending/data/greatschools/test_data.csv'      # The CSV with 'name' and 'overview-url'
    output_csv = 'E:/_UChicago/MACS30122/final-project-ascending/data/greatschools/test_reviews.csv'
