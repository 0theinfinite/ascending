...
class SchoolReviewsScraper:
    ...
    def clean_text(self, text):
        """
        Clean text by removing extra whitespace, special characters,
        stop words, and lower case.
        """
        text = text.replace('\n', ' ').replace('\r', ' ')
        text = ' '.join(text.split())
        text = text.lower()
        stop_words = ['the', 'a', 'an', 'is', 'this', 
                      'that', 'it', 'to', 'and', 'of', 
                      'for', 'in', 'on', 'with', 'at', 
                      'by', 'as', 'from', 'you', 'your', 
                      'we', 'our', 'they', 'their', 'he', 
                      'she', 'his', 'her', 'him', 'i', 
                      'me', 'my', 'mine', 'us', 'they', 
                      'them', 'their', 'theirs', 'itself', 
                      ...
                      'whatever', 'when', 'where', 'why', 
                      'how', 'if', 'then', 'else', 'or', 
                      'and', 'but', 'so', 'because', 'since', 
                      'while', 'although', 'though', 'even', 
                      'if', 'unless', 'until', 'before', 
                      'after', 'when', 'where', 'while', 
                      'because', 'since', 'if', 'unless', 
                      'until', 'before', 'after', 'both', 
                      'either', 'neither', 'each', 'every', 
                      'any', 'all', 'some', 'no', 'not', 
                      'none', 'nothing', 'nobody', 'nowhere', 
                      'never', 'everybody', 'everyone', 
                      'everything', 'everywhere', 'anybody', 
                      'anyone', 'anything', 'anywhere', 'somebody', 
                      'someone', 'something', 'somewhere', 
                      'nobody', 'none', 'nothing', 'nowhere', 
                      'never', 'here', 'there', 'this', 'that', 
                      'these', 'those', 'one', 'two', 'three', 
                      'four', 'five', 'first', 'second', 'third', 
                      'last', 'next', 'previous', 'many', 'much', 
                      'more', 'most', 'few', 'little', 'less', 
                      'least', 'own', 'other', 'another', 'such', 
                      'same', 'different', 'similar', 'good', 'bad',]
    ...
    def analyze_sentiment(self, review_text):
        ...
        VADER is chosen for its speed and good performance on social media text.
